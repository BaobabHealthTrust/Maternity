class ApplicationController < ActionController::Base
  ...
  before_filter :login_required, :except => ['login', 'logout','demographics', 'add_update_property',
    'observations_printable', 'cohort_print', 'print_cohort', 'birth_report', 'issue_baby_ids', 'report', 'diagnoses_report', 'birth_report_printable', 'birth_report']
  before_filter :location_required, :except => ['login', 'logout', 'birth_cohort', 'location','demographics',
    'add_update_property', 'observations_printable', 'diagnoses_report', 'issue_baby_ids', 'cohort_print','report','print_cohort', 'birth_report_printable', 'birth_report']
